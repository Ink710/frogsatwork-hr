...
const es = {
  ...
  "reports.sources": "Efectividad por campaña",
  "reports.source": "Campaña",
  "reports.channels": "Efectividad por canal",
  "reports.channel": "Canal",
  "reports.channelsHint": "Campañas agrupadas por el canal al que pertenecen — de dónde vienen los postulantes en general.",
  "reports.unattributed": "Desconocido",
  ...
  // Registro de campañas (M2)
  "campaigns.title": "Campañas",
  "campaigns.subtitle": "De dónde vienen los postulantes. Cada campaña tiene un enlace de seguimiento y se agrupa por canal en los reportes.",
  "campaigns.listTitle": "Campañas",
  "campaigns.name": "Nombre",
  "campaigns.namePlaceholder": "LinkedIn — Egresados de marzo",
  "campaigns.slug": "Identificador de seguimiento",
  "campaigns.channel": "Canal",
  "campaigns.add": "Agregar campaña",
  "campaigns.rename": "Renombrar",
  "campaigns.archive": "Archivar",
  "campaigns.restore": "Restaurar",
  "campaigns.archivedPill": "Archivada",
  "campaigns.applications": "{n} postulación(es)",
  "campaigns.empty": "Aún no hay campañas. Agrega una para empezar a rastrear de dónde vienen los postulantes.",
  "campaigns.duplicateSlug": "Ese identificador de seguimiento ya está en uso.",
  "campaigns.notFound": "Esa campaña ya no existe.",
  "campaigns.saveFailed": "No se pudo guardar la campaña. Inténtalo de nuevo.",
  "campaigns.slugNote":
    "El identificador es el valor ?source= del enlace de seguimiento, por lo que no puede cambiarse una vez publicado — los enlaces ya difundidos dejarían de acreditarse. Archiva la campaña en su lugar; las postulaciones que generó conservan su atribución.",
  "enum.sourceChannel.CAREERS_PAGE": "Página de empleo",
  "enum.sourceChannel.COMPANY_WEBSITE": "Sitio web de la empresa",
  "enum.sourceChannel.REFERRAL": "Referido",
  "enum.sourceChannel.LINKEDIN": "LinkedIn",
  "enum.sourceChannel.FACEBOOK": "Facebook",
  "enum.sourceChannel.INSTAGRAM": "Instagram",
  "enum.sourceChannel.JOB_BOARD": "Portal de empleo",
  "enum.sourceChannel.OTHER": "Otro",
  ...
  "withdraw.confirm": "Sí, retirar",
  "withdraw.confirmHint": "Los marca como retirados. Puedes reabrirlos después desde la lista de cerrados.",
  ...
  "app.source": "Origen",
  "questions.title": "Preguntas de filtro",
  "questions.hint": "Se muestran en el formulario público de esta vacante. Las respuestas aparecen en cada postulación.",
  "questions.empty": "Esta vacante no tiene preguntas de filtro.",
  "questions.prompt": "Pregunta",
  "questions.promptPlaceholder": "¿Tienes autorización para trabajar en este país?",
  "questions.options": "Opciones",
  "questions.optionsPlaceholder": "Una opción por línea",
  "questions.required": "Obligatoria",
  "questions.requiredPill": "Obligatoria",
  "questions.optionalPill": "Opcional",
  "questions.archivedPill": "Archivada",
  "questions.answers": "{n} respuesta(s)",
  "questions.add": "Agregar pregunta",
  "questions.edit": "Editar",
  "questions.save": "Guardar",
  "questions.archive": "Archivar",
  "questions.restore": "Restaurar",
  "questions.notFound": "Esa pregunta ya no existe.",
  "questions.saveFailed": "No se pudo guardar la pregunta. Inténtalo de nuevo.",
  "answers.title": "Respuestas de filtro",
  "enum.questionType.SHORT_TEXT": "Respuesta corta",
  "enum.questionType.LONG_TEXT": "Respuesta larga",
  "enum.questionType.YES_NO": "Sí / No",
  "enum.questionType.SINGLE_SELECT": "Opción múltiple",
  "submitted.title": "Lo que enviaron",
  "submitted.hint": "Experiencia y formación tal como llegaron con esta postulación — editar el perfil después no las cambia.",
  "submitted.present": "Actualidad",
  "app.phone": "Teléfono",
  "app.email": "Correo",
  ...
  "err.roundsRemaining": "Termina las rondas de entrevista antes de pasar a Oferta.",
  "err.notWithdrawn": "Solo se puede reabrir una postulación retirada.",
