...
const en = {
  ...
  "reports.sources": "Campaign effectiveness",
  "reports.source": "Campaign",
  "reports.channels": "Channel effectiveness",
  "reports.channel": "Channel",
  "reports.channelsHint": "Campaigns rolled up to the channel they belong to — where the applicants come from overall.",
  "reports.unattributed": "Unknown",
  ...
  // Campaign registry (M2)
  "campaigns.title": "Campaigns",
  "campaigns.subtitle": "The places applicants come from. Each campaign has a tracking link and rolls up to a channel on reports.",
  "campaigns.listTitle": "Campaigns",
  "campaigns.name": "Name",
  "campaigns.namePlaceholder": "LinkedIn — March grads",
  "campaigns.slug": "Tracking slug",
  "campaigns.channel": "Channel",
  "campaigns.add": "Add campaign",
  "campaigns.rename": "Rename",
  "campaigns.archive": "Archive",
  "campaigns.restore": "Restore",
  "campaigns.archivedPill": "Archived",
  "campaigns.applications": "{n} application(s)",
  "campaigns.empty": "No campaigns yet. Add one to start tracking where applicants come from.",
  "campaigns.duplicateSlug": "That tracking slug is already in use.",
  "campaigns.notFound": "That campaign no longer exists.",
  "campaigns.saveFailed": "Could not save the campaign. Try again.",
  "campaigns.slugNote":
    "A slug is the ?source= value in a tracking link, so it cannot be changed once published — links already in the wild would stop being credited. Archive a campaign instead; the applications it produced keep their attribution.",
  "enum.sourceChannel.CAREERS_PAGE": "Careers page",
  "enum.sourceChannel.COMPANY_WEBSITE": "Company website",
  "enum.sourceChannel.REFERRAL": "Referral",
  "enum.sourceChannel.LINKEDIN": "LinkedIn",
  "enum.sourceChannel.FACEBOOK": "Facebook",
  "enum.sourceChannel.INSTAGRAM": "Instagram",
  "enum.sourceChannel.JOB_BOARD": "Job board",
  "enum.sourceChannel.OTHER": "Other",
  ...
  "app.source": "Source",
  "questions.title": "Screening questions",
  "questions.hint": "Asked on the public application form for this requisition. Answers appear on each application.",
  "questions.empty": "No screening questions on this req.",
  "questions.prompt": "Question",
  "questions.promptPlaceholder": "Are you authorised to work in this country?",
  "questions.options": "Options",
  "questions.optionsPlaceholder": "One option per line",
  "questions.required": "Required",
  "questions.requiredPill": "Required",
  "questions.optionalPill": "Optional",
  "questions.archivedPill": "Archived",
  "questions.answers": "{n} answer(s)",
  "questions.add": "Add question",
  "questions.edit": "Edit",
  "questions.save": "Save",
  "questions.archive": "Archive",
  "questions.restore": "Restore",
  "questions.notFound": "That question no longer exists.",
  "questions.saveFailed": "Could not save the question. Try again.",
  "answers.title": "Screening answers",
  "enum.questionType.SHORT_TEXT": "Short answer",
  "enum.questionType.LONG_TEXT": "Long answer",
  "enum.questionType.YES_NO": "Yes / No",
  "enum.questionType.SINGLE_SELECT": "Multiple choice",
  "submitted.title": "What they submitted",
  "submitted.hint": "Work history and education exactly as sent with this application \u2014 a later profile edit does not change it.",
  "submitted.present": "Present",
  "app.phone": "Phone",
  "app.email": "Email",
